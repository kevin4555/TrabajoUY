                        ...
                        <div class="col">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item"><b>Horario:</b> <%= oferta.getHorarioInicio() %> - <%= oferta.getHorarioFinal() %></li>
                                                ...
                                                <li class="list-group-item"><b>Estado de la Oferta:</b> <%= oferta.getEstadoOferta() %></li>
                                                <% } %>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="card cardOferta mb-3">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="data:image/png;base64,<%= paquete.getImagenBase64() %>"
                                        ...
                                        <div class="col-md-8">
								            ...
								            %>
                                                ...
                                                <p class="card-text"><a href="<%= paqueteUrl %>" class="btn btn-primary">Ir a Paquete</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
