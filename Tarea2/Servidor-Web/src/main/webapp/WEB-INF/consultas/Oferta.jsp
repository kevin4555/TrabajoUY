<%@page import="logica.datatypes.DtOfertaLaboral"%> <%@page
import="java.util.ArrayList"%> <%@page import="logica.datatypes.Dtusuario"%>
<%@page import="model.TipoUsuario"%> <%@page import="model.EstadoSesion"%> <%@
                ...
                <div class="card">
                  <div class="row g-0">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        <h5
                          class="card-header p-0 border-0 bg-white text-start"
                        >
                          ${oferta.nombre}
                        </h5>
                      ...
                      <div class="card-body">
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item">
                            <b>Remuneración:</b> ${oferta.remuneracion}
                          </li>
                          <li class="list-group-item">
                            <b>Horario:</b> ${oferta.horarioInicio} -
                            ${oferta.horarioFinal}
                          </li>
                          <li class="list-group-item">
                            <b>Departamento:</b> ${oferta.departamento}
                          </li>
                          <li class="list-group-item">
                          ...
                          >
                            <li class="list-group-item">
                              <b>Estado de la Oferta:</b> ${oferta.estadoOferta}
                            </li>
                          </c:if>
                        </ul>
                      </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <p class="card-text">
                          ...
                          <a href="${perfilURL}"
                            >${postulacion.nicknamePostulante}</a
                          >
                        </p>
