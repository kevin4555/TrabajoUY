			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<c:if test="${tipoUsuario == TipoUsuaio.TipoUsuario.EMPRESA }">
						<tr>
							<td class="d-flex"><a class="btn"
								href="${pageContext.request.contextPath}/altaOferta">Alta Oferta</a></td>
						</tr>
					...
					<tr>
						<td class="d-flex"><a class="btn" href="${pageContext.request.contextPath}/consultaPaquetes">Ver tipos de
								paquetes</a></td>
					</tr>
					<tr>
						<td class="d-flex"><a class="btn" href="${pageContext.request.contextPath}/consultaOfertas">Consulta
								ofertas laborales</a></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<c:forEach var="key" items="${listaKeywords}">
						...
						<tr>
							<td><a class="btnKeyword btn" href="${keywordUrl}">${key}</a>
							</td>
						</tr>
					</c:forEach>
