 ...
 * 
 */
@WebFault(name = "UsuarioEmailRepetidoException", targetNamespace = "http://webservices.logica/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: logica.webservices.UsuarioEmailRepetidoException
     */
