 ...
 *         <element name="postulaciones" type="{http://webservices.java.main/}dtPostulacion" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="estadoOferta" type="{http://webservices.java.main/}estadoOferta" minOccurs="0"/>
 *         <element name="imagenBase64" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         <element name="paqueteAsociado" type="{http://webservices.java.main/}dtPaquetePublicacion" minOccurs="0"/>
