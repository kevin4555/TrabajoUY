 ...
 * 
 */
@WebServiceClient(name = "PublicadorService", targetNamespace = "http://webservices.java.main/", wsdlLocation = "http://localhost:8085/webservices?wsdl")
    ...
    extends Service
{
    ...
    public Publicador getPublicadorPort() {
        return super.getPort(new QName("http://webservices.java.main/", "PublicadorPort"), Publicador.class);
    }
    ...
    public Publicador getPublicadorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.java.main/", "PublicadorPort"), Publicador.class, features);
    }
