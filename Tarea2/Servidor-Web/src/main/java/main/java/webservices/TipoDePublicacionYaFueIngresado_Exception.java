 ...
 * 
 */
@WebFault(name = "TipoDePublicacionYaFueIngresado", targetNamespace = "http://webservices.java.main/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: main.java.webservices.TipoDePublicacionYaFueIngresado
     */
