...
public interface Publicador {
    ...
    @Action(input = "http://webservices.java.main/Publicador/removerOfertaFavoritaRequest", output = "http://webservices.java.main/Publicador/removerOfertaFavoritaResponse", fault = {
        ...
        @FaultAction(className = OfertaLaboralNoExisteException_Exception.class, value = "http://webservices.java.main/Publicador/removerOfertaFavorita/Fault/OfertaLaboralNoExisteException")
    })
    public void removerOfertaFavorita(
        ...
        @WebParam(name = "arg1", partName = "arg1")
        String arg1)
        throws OfertaLaboralNoExisteException_Exception, PostulanteNoEsOfertaFavoritaException_Exception, UsuarioNoExisteException_Exception
    ;
