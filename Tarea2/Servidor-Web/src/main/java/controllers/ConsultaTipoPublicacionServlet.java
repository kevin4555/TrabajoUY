 ...
 * ConsultaTipoPostulacionServlet
 */
@WebServlet("/consultaTipoPublicacion")
public class ConsultaTipoPublicacionServlet
      extends HttpServlet {
  ...
  private void procesarResquest(HttpServletRequest request,
    ...
    request.getRequestDispatcher(
          "/WEB-INF/consultas/ConsultaTipoPublicacion.jsp")
          .forward(request, response);
