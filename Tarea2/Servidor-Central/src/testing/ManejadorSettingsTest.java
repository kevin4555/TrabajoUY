...
public class ManejadorSettingsTest {
  ...
  @Test
  public void pruebasGeneralesSettings() throws TipoPublicacionYaExisteException,
      KeywordYaExisteException, KeywordNoExisteException, TipoPublicacionNoExisteException {
    ManejadorSettings manejadorSettings = ManejadorSettings.getInstance();
    
    TipoPublicacion tipoPublicacion = new TipoPublicacion("tipoPublicacion", "Descripcion",
        "23", 3, 33.2f, this.fechaDate);
    ...
    Assert.assertEquals(tipoPublicacion,
        manejadorSettings.obtenerTipoPublicacion(tipoPublicacion.getNombre()));
