...
public class ControladorOfertaTest {
  ...
  public void testListarPaquetes()
    ...
    PaquetePublicacion paquetePruebaPrimero = new PaquetePublicacion(
        "nombrePruebaPrimero", "descripcionPrueba", 20, 50f,
        null, arrayPruebaSegundo, fechaDate);
    
    PaquetePublicacion paquetePrueba = new PaquetePublicacion(
        "nombrePrueba", "descripcionPrueba", 20, 50f, null,
  ...
  public void agregarTipoPublicacionAlPaquete()
    ...
    TipoPublicacion publicacionPruebaSegunda = new TipoPublicacion(
        "tipoPublicacionPruebaSeguda", "descripcionPrueba",
        "alta", 20, 50f, fechaDate);
    manejadorSettings
  ...
  public void testRegistrarPostulacion()
      ...
      TipoPublicacionYaExisteException,
      TipoPublicacionNoExisteException,
      KeywordNoExisteException, UsuarioYaExistePostulacion {
    manejadorOfertas = ManejadorOfertas.getInstance();
    manejadorSettings = ManejadorSettings.getInstance();
    manejadorPaquetes = ManejadorPaquetes.getInstance();
    manejadorUsuario = ManejadorUsuario.getInstance();
  ...
  public void testObtenerDtPaquetePublicacion()
    ...
    Assert.assertEquals(
        String.valueOf(paquetePublicacionDt.getDescuento()),
        String
            .valueOf(paquetePruebaPrimero.getDescuento()));
    Assert.assertEquals(
    ...
    Assert.assertEquals(paquetePublicacionDt.getNombre(),
        "nombrePruebaPrimero");
    Assert.assertEquals(
        paquetePublicacionDt.getCantidadTipoPublicaciones()
  ...
  public void testObtenerKeywordsDeOfertaLaboral()
    ...
    Assert.assertEquals(
        controladorOferta
            .obtenerKeywordsDeOfertaLaboral("test").get(0),
        "Keyword1");
  }
  ...
  public void testObtenerDtofertasPorKeyword()
    ...
    Assert.assertEquals(String.valueOf(
        resultadoOfertaLaboralDt.get(0).getRemuneracion()),
        String.valueOf(500f));
