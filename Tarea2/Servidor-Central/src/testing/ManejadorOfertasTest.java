...
public class ManejadorOfertasTest {
  ...
  public void testAgregaryobtenerOferta()
    ...
    manejadorOfertas = ManejadorOfertas.getInstance();
    TipoPublicacion tipoCreadoPublicacion = new TipoPublicacion(
  ...
  public void testAgregarOfertaDuplicada()
    ...
    OfertaLaboral oferta = new OfertaLaboral(
        "nombreTesting", "Descipcion para testing", "09:00",
        "15:00", 10F, "Montevideo", "Montevideo", fechaDate,
        tipoCreadoPublicacion, null, empresa1);
    manejadorOfertas.agregarOferta(oferta);
    try {
      manejadorOfertas.agregarOferta(oferta);
  ...
  public void testObtenerDtycompararlo()
    ...
    DtOfertaLaboral dtOfertaLaboral = new DtOfertaLaboral(
        "nombreTesting", "descripcionTesting",
        "ciudadTesting", "departamentoTesting", "09:00",
        "15:00", 100f, fechaDate, arrayDt, fechaDate,
        EstadoOferta.CONFIRMADA, null, null, null, false,
