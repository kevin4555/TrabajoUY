...
public class PaquetePublicacion {
	...
	public PaquetePublicacion(String nombre, String descripcion, int periodoValidez, float descuento,
			BufferedImage imagen, List<CantidadTotalTipoPublicacion> cantidadTipo, LocalDate fechaAlta) {
		this.nombre = nombre;
	...
	public void setCantidadTotalTipoPublicaciones(List<CantidadTotalTipoPublicacion> cantidadTipoPublicaciones) {
	...
	public DtPaquetePublicacion obtenerDtPaquete() throws IOException {
		...
		return new DtPaquetePublicacion(nombre, descripcion, periodoValidez, descuento, costo, imagen, listDtcantidad,
				fechaAlta);
	}
	...
	public void agregarTipoPublicacion(TipoPublicacion tipoPublicacion, int cantidad)
		...
		if (!estaComprado) {
			...
			throw new PaquetePublicacionYaFueComprado("El paquete " + getNombre() + " ya fue comprado");
		}
	}
