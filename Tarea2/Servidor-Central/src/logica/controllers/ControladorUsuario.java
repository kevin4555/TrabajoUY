...
public class ControladorUsuario implements IcontroladorUsuario
{
	...
	@Override
	public List<String> obtenerOfertasEmpresa(String nicknameEmpresa) throws UsuarioNoExisteException
	{
		ManejadorUsuario manejadorUsuarios = ManejadorUsuario.getInstance();
	...
	{
		ManejadorUsuario manejadorUsuario = ManejadorUsuario.getInstance();
		Postulante postulante = new Postulante(nickname, nombre, apellido, email.toLowerCase(), fechaNac, nacionalidad,
				imagen, constrasenia);
	...
	{
		ManejadorUsuario manejadorUsuarios = ManejadorUsuario.getInstance();
		Empresa empresa = new Empresa(nickname, nombre, apellido, email.toLowerCase(), descripcion, link.toLowerCase(),
				imagen, contrasenia);
	...
	@Override
	public List<String> listaOfertasUsuario(String nickname) throws UsuarioNoExisteException
	{
		Usuario usuario = this.obtenerUsuario(nickname);
	...
	@Override
	public void editarPostulante(String nickname, String nombre, String apellido, LocalDate fechaNacimiento,
	...
	@Override
	public List<DtOfertaLaboral> obtenerDtofertasConfirmadasDeEmpresa(String nicknameEmpresa)
			throws UsuarioNoExisteException, IOException
	{
		Empresa empresa = ManejadorUsuario.getInstance().obtenerEmpresa(nicknameEmpresa);
	...
	@Override
	public void comprarPaquete(String nicknameEmpresa, String nombrePaquete, LocalDate fechaCompra)
	...
	@Override
	public List<String> listarPaquetesNoCompradosDeEmpresa(String nicknameEmpresa) throws UsuarioNoExisteException
	{
		Empresa empresa = ManejadorUsuario.getInstance().obtenerEmpresa(nicknameEmpresa);
	...
	public void agregarOfertaFavorita(String nicknamePostulante, String nombreOferta)
			throws UsuarioNoExisteException, PostulanteYaEsOfertaFavoritaException, OfertaLaboralNoExisteException
	{
		Postulante postulante = ManejadorUsuario.getInstance().obtenerPostulante(nicknamePostulante);
		if (postulante.esOfertaFavorita(nombreOferta))
		{
			throw new PostulanteYaEsOfertaFavoritaException(
					"El postulante " + nicknamePostulante + " ya tiene como favorita la oferta " + nombreOferta);
		}
		IcontroladorOferta controladorOferta = Fabrica.getInstance().obtenerControladorOferta();
		if (!controladorOferta.existeOfertaLaboral(nombreOferta))
		{
			throw new OfertaLaboralNoExisteException("La oferta laboral " + nombreOferta + " no existe");
		}
	...
	{
		Postulante postulante = ManejadorUsuario.getInstance().obtenerPostulante(nicknamePsotulante);
		if (!postulante.esOfertaFavorita(nombreOferta))
		{
