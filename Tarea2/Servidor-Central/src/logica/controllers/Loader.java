...
public class Loader {
  ...
  public void cargarDatos() throws UsuarioNoExisteException, OfertaLaboralNoExisteException,
    ...
    controladorUsuario.altaEmpresa("EcoTech", "Sophia", "Johnson", "info@EcoTech.com",
        ...
        "http://www.EcoTechInnovations.com", this.getBufferImage("U11.jpg"),
        "qsxcdw43");
    controladorUsuario.altaEmpresa("FusionTech", "William", "Smith", "contacto@FusionTech.net",
        ...
        "http://www.fusiontechdynamics.net", this.getBufferImage("U12.jpg"),
        "qpwoei586");
    controladorUsuario.altaEmpresa("GlobalHealth", "Isabella", "Brown", "jobs@GlobalHealth.uy",
        ...
        "http://www.globalhealthdynamics.uy/info", this.getBufferImage("U13.jpg"),
        "asdfg654");
    controladorUsuario.altaEmpresa("ANTEL", "Washington", "Rocha", "jarrington@ANTEL.com.uy",
        ...
        "ANTEL.com.uy", this.getBufferImage("U14.jpg"), "2nru096");
    controladorUsuario.altaEmpresa("MIEM", "Pablo", "Bengoechea", "eldiez@MIEM.org.uy",
        ...
        "MIEM.com.uy", this.getBufferImage("U15.jpg"), "ibii4xo");
    controladorUsuario.altaEmpresa("TechSolutions", "Mercedes", "Venn",
        ...
        "TechSolutions.com", this.getBufferImage("U16.jpg"), "1ngs03p");
    ...
    controladorOferta.registrarPaquete("Básico",
        ...
        this.getBufferImage("paq1.jpg"), LocalDate.parse("2023-08-16"), paquete1);
    ...
    controladorOferta.registrarPaquete("Destacado",
        ...
        45, 10f, this.getBufferImage("paq2.jpg"), LocalDate.parse("2023-08-15"),
        paquete2);
    ...
    controladorOferta.registrarPaquete("Premium",
        ...
        60, 15f, this.getBufferImage("paq3.jpg"), LocalDate.parse("2023-08-14"),
        paquete3);
    ...
    controladorOferta.altaOfertaLaboral("Desarrollador Frontend",
        ...
        "Premium", "EcoTech", keywords, this.getBufferImage("O1.jpg"), "Básico");
    ...
    controladorOferta.altaOfertaLaboral("Estratega de Negocios",
        ...
        "Estándar", "GlobalHealth", keywords2, this.getBufferImage("O2.jpg"), null);
    ...
    controladorOferta.altaOfertaLaboral("Diseñador UX/UI",
        ...
        "Estándar", "FusionTech", keywords3, this.getBufferImage("O3.jpg"), null);
    ...
    controladorOferta.altaOfertaLaboral("Analista de Datos",
        ...
        "Premium", "ANTEL", keywords4, this.getBufferImage("O4.jpg"), null);
    ...
    controladorOferta.altaOfertaLaboral("Content Manager",
        ...
        "Destacada", "MIEM", keywords5, this.getBufferImage("O5.jpg"), null);
    ...
    controladorOferta.altaOfertaLaboral("Soporte Técnico",
        ...
        "Básica", "TechSolutions", keywords6, this.getBufferImage("O6.jpg"),
        "Destacado");
    ...
    controladorOferta.altaOfertaLaboral("A. de Marketing Digital",
        ...
        "EcoTech", keywords7, this.getBufferImage("O7.jpg"), null);
    ...
    controladorOferta.altaOfertaLaboral("Contador Senior",
        ...
        "Destacada", "GlobalHealth", keywords8, this.getBufferImage("O8.jpg"), null);
    ...
    controladorOferta.altaOfertaLaboral("Técnico/a Básico Red",
        ...
        "Premium", "ANTEL", keywords9, this.getBufferImage("O9.jpg"), null);
    ...
    controladorOferta.altaOfertaLaboral(
        ...
        "Premium", "TechSolutions", keywords11, this.getBufferImage("O11.jpg"), null);
    ...
    controladorOferta.altaOfertaLaboral("Gerente de Proyecto",
        ...
        "Destacada", "TechSolutions", keywords12, this.getBufferImage("O12.jpg"),
        null);
    ...
    controladorOferta.altaOfertaLaboral("Ingeniero de Calidad de " + "Software",
        ...
        "Premium", "EcoTech", keywords13, this.getBufferImage("O13.jpg"), null);
  ...
  public void confirmarOfertas() throws OfertaLaboralNoExisteException {
    ...
    controladorOferta.aceptarRechazarOfertaLaboral("Técnico/a Básico Red",
        EstadoOferta.CONFIRMADA, LocalDate.parse("2023-09-29"));
    controladorOferta.aceptarRechazarOfertaLaboral("Gerente de Proyecto",
        EstadoOferta.CONFIRMADA, LocalDate.parse("2023-10-01"));
