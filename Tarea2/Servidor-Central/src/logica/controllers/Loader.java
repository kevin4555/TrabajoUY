...
public class Loader {
  ...
  public void cargarDatos() throws UsuarioNoExisteException, OfertaLaboralNoExisteException,
    ...
    controladorUsuario.altaEmpresa("EcoTech", "Sophia", "Johnson", "info@EcoTech.com",
        ...
        "http://www.EcoTechInnovations.com", this.getBufferImage("usuarios/U11.jpg"),
        "qsxcdw43");
    controladorUsuario.altaEmpresa("FusionTech", "William", "Smith", "contacto@FusionTech.net",
        ...
        "http://www.fusiontechdynamics.net", this.getBufferImage("usuarios/U12.jpg"),
        "qpwoei586");
    controladorUsuario.altaEmpresa("GlobalHealth", "Isabella", "Brown", "jobs@GlobalHealth.uy",
        ...
        "http://www.globalhealthdynamics.uy/info", this.getBufferImage("usuarios/U13.jpg"),
        "asdfg654");
    ...
    controladorOferta.registrarPaquete("Destacado",
        ...
        45, 10f, this.getBufferImage("paquetes/paq2.jpg"), LocalDate.parse("2023-08-15"),
        paquete2);
    ...
    controladorOferta.registrarPaquete("Premium",
        ...
        60, 15f, this.getBufferImage("paquetes/paq3.jpg"), LocalDate.parse("2023-08-14"),
        paquete3);
    ...
    controladorOferta.registrarPaquete("Express",
        ...
        15, 5f, this.getBufferImage("paquetes/paq4.jpg"), LocalDate.parse("2023-08-13"),
        paquete4);
    ...
    controladorOferta.altaOfertaLaboral("Soporte Técnico",
        ...
        "Básica", "TechSolutions", keywords6, this.getBufferImage("ofertas/O6.jpg"),
        "Destacado");
    ...
    controladorOferta.altaOfertaLaboral("Gerente de Proyecto",
        ...
        "Destacada", "TechSolutions", keywords12, this.getBufferImage("ofertas/O12.jpg"),
        null);
